...
Этот файл — общая точка входа в репозиторий и ветку `main`. Подробности реализации: [backend](backend/README.md), [frontend](frontend/README.md). Состояние описано по коду `b0523fd` и материалам репозитория на **23 сентября 2026 года**.
